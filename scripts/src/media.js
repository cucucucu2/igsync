class Media {
  ...
  static template(item, i) {
    ...
    const profile = `${item.owner.username}/`;
      ...
      `<div class="card-image card-video">
        ...
        <div id="${id}" class="mfp-figure mfp-hide mfp-video">
          ...
          <div class="mfp-bottom-bar"><div class="mfp-title"><div class="card-owner">
            <span>${caption}</span>
            <small>by ${item.owner.username} ${timeago} atrás</small>
          </div></div></div>
        </div>` :
      ...
      <div class="card" data-id="${i}">
        <div class="card-content card-header">
          <a class="left card-profile">
            <img src="https://instagram.fbel1-1.fna.fbcdn.net/vp/af3b34545b58618fb76ecb67db75be3a/5BB27DAB/t51.2885-19/s320x320/14719833_310540259320655_1605122788543168512_a.jpg">
          </a>
          <a href="${link}" class="right" target="_blank">
            <time data-date="${+date}" title="${fulldate}">${timeago}</time>
          </a>
          <div class="card-owner">
            <a class="owner" href="https://www.instagram.com/web/friendships/${profile}follow" target="_blank">${item.owner.username}</a>
            <span class="location">
              <br>
        ...
        <div class="card-action">
          ...
          <a class="btn-link reloadBtn" title="Recarregar">
            <i class="material-icons">refresh</i>
          </a>
          <a class="btn-link deleteBtn" title="Apagar">
